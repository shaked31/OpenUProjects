...
Server::Server(asio::io_context& context, const unsigned short int port):
    a(context, asio::ip::tcp::endpoint(asio::ip::tcp::v4(), port)) {} // Constructor
...
[[noreturn]] void Server::run() {
    ...
    try {
        ...
        while (true) {
            asio::ip::tcp::socket sock = a.accept();
